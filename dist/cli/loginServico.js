 ...
 */
export async function runLoginServico() {
    ...
    try {
        ...
        shopId = (await rl.question("\nOficina padrão para consultar_estoque (UUID, opcional, Enter para pular): ")).trim();
        ...
        stdout.write(`Em produção (runtime do Aurora) NÃO use este comando: defina ${ENV_VARS.serviceSecret[0]} e ` +
