...
import { objeto, textoObrigatorio, textoOpcional } from "./args.js";
export const RESPONDER_BUSCA_PECA_TOOL = {
    name: "responder_busca_peca",
    title: "Registrar resposta do fornecedor a uma busca de peça",
    description: "Entrega ao portal a resposta que um fornecedor mandou no WhatsApp sobre uma busca de peça " +
    ...
    inputSchema: {
        ...
        properties: {
            candidateId: {
                type: "string",
                description: "Id do PartSearchCandidate que originou o contato — vem da mensagem enviada ao fornecedor. " +
            ...
            externalId: {
                type: "string",
                description: "Id da mensagem no provedor de WhatsApp, quando houver. Serve para conciliar a auditoria.",
            },
        },
...
export async function runResponderBuscaPeca(creds, args) {
    const a = objeto(args);
    return apiRequest(creds, "/buscas/webhook/resposta-fornecedor", {
        method: "POST",
        auth: "servico",
        body: {
