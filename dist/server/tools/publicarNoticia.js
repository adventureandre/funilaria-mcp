...
import { listaDeTextosOpcional, objeto, textoObrigatorio, textoOpcional, } from "./args.js";
export const PUBLICAR_NOTICIA_TOOL = {
    name: "publicar_noticia",
    title: "Enviar matéria para o CMS (rascunho)",
    description: "Entrega uma matéria de notícia ao portal Funilaria & Pintura (POST /noticias/ingestao). " +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            content: {
                type: "string",
                minLength: 50,
                description: "Corpo da matéria em Markdown. Se sourceUrl for informado, o crédito à fonte é anexado " +
            ...
            sourceUrl: {
                type: "string",
                description: "URL da matéria original. Precisa ser uma URL válida — vira o crédito no rodapé do post.",
            },
            sourceName: {
                type: "string",
            ...
            categorySlug: {
                type: "string",
                description: "Slug de uma categoria já existente no CMS. Se o slug não existir, a matéria entra sem " +
...
export async function runPublicarNoticia(creds, args) {
    const a = objeto(args);
    return apiRequest(creds, "/noticias/ingestao", {
        method: "POST",
        auth: "servico",
        body: {
