...
import { CATALOGO_INDISPONIVEL_TOOL, callCatalogTool, fetchCatalog, } from "./catalog/remoteCatalog.js";
...
export async function startServer() {
    ...
    process.stderr.write(catalogo.ok
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        if (!disponiveis.has(name)) {
            return errorContent(new Error(`Tool desconhecida: ${name}. Disponíveis: ${[...disponiveis].join(", ")}.`));
        }
        try {
